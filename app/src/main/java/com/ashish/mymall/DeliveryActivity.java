...
public class DeliveryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Teslimat");
        ...
        changeORaddNewAddressBtn.setText("Adresi değiştir veya yeni bir adres ekle");
    ...
    protected void onStart() {
                                                               ...
                                                               for (String qtyID : cartItemModelList.get(finalX).getQtyIDs()) {
                                                                   ...
                                                                   if (!serverQuantity.contains(qtyID)) {
                                                                       if(noLongerAvailable){
                                                                           ...
                                                                           Toast.makeText(DeliveryActivity.this, "Üzgünüz, Gerekli miktar mevcut değil", Toast.LENGTH_SHORT).show();
                                                                       }
        ...
        if(DBquerries.addressesModelList.get(DBquerries.selectedAddress).getAlternateMobileNo().equals("")){
            ...
            fullname.setText(name + " - " + mobileNo+" veya "+DBquerries.addressesModelList.get(DBquerries.selectedAddress).getAlternateMobileNo());
        }
    ...
    private void showConfirmationLayout() {
        ...
        orderId.setText("Sipariş Kimliği" + order_id);
    ...
    private void paytm(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                    ...
                    if (jsonObject.has("CHECKSUMHASH")) {
                        ...
                        paytmPGService.startPaymentTransaction(DeliveryActivity.this, true, true, new PaytmPaymentTransactionCallback() {
                                                                ...
                                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                    ...
                                                                    public void onComplete(@NonNull Task<Void> task) {
                                                                        if(task.isSuccessful()){
                                                                            ...
                                                                            Toast.makeText(DeliveryActivity.this, "Kullanıcı siparişleri listesi güncellenemedi!", Toast.LENGTH_LONG).show();
                                                                        }
                                                                    }
                                                                });
                                                    }else {
                                                        Toast.makeText(DeliveryActivity.this, "Sipariş iptal edildi !", Toast.LENGTH_LONG).show();
                                                    }
                                                }
                                            });
                                }
                            ...
                            public void networkNotAvailable() {
                                Toast.makeText(getApplicationContext(), "Ağ bağlantısı hatası!", Toast.LENGTH_LONG).show();
                            }

                            @Override
                            public void clientAuthenticationFailed(String s) {
                                Toast.makeText(getApplicationContext(), "Kimlik doğrulama başarısız oldu: sunucu hatası" + s, Toast.LENGTH_LONG).show();
                            }

                            @Override
                            public void someUIErrorOccurred(String s) {
                                Toast.makeText(getApplicationContext(), "kullanıcı arayüzü hatası " + s, Toast.LENGTH_LONG).show();
                            }

                            @Override
                            public void onErrorLoadingWebPage(int i, String s, String s1) {
                                Toast.makeText(getApplicationContext(), "Web sayfası yüklenemiyor" + s.toString(), Toast.LENGTH_LONG).show();
                            }
                            ...
                            public void onTransactionCancel(String s, Bundle bundle) {
                                Toast.makeText(getApplicationContext(), "İşlem iptal edildi" + bundle.toString(), Toast.LENGTH_LONG).show();
                            }
                        });
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                loadingDialog.dismiss();
                Toast.makeText(DeliveryActivity.this, "Bir şeyler yanlış gitti!", Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
