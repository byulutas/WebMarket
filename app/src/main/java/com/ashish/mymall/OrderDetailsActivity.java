...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Sipariş detayları");
        ...
        qty.setText("Adet :"+String.valueOf(model.getProductQuantity()));
        ...
        switch (model.getOrderStatus()){
            ...
            case "out for Delivery":
                ...
                deliveredTitle.setText("Dağıtıma çıkmış");
                deliveredBody.setText("Siparişiniz teslimata çıktı");
            ...
            case "Cancelled":
                ...
                if(model.getPackedDate().after(model.getOrderedDate())){
                    ...
                    if(model.getShippedDate().after(model.getPackedDate())){
                        ...
                        deliveredIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.successGreen)));
                        deliveredDate.setText(String.valueOf(simpleDateFormat.format(model.getDelveredDate())));
                        deliveredBody.setText("Siparişiniz iptal edildi.");
                        deliveredTitle.setText("İptal edildi");
                        ...
                        shippedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.successGreen)));
                        shippedDate.setText(String.valueOf(simpleDateFormat.format(model.getShippedDate())));
                        shippedBody.setText("Siparişiniz iptal edildi.");
                        shippedTitle.setText("İptal edildi");
                    ...
                    packedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.successGreen)));
                    packedDate.setText(String.valueOf(simpleDateFormat.format(model.getPackedDate())));
                    packedBody.setText("Siparişiniz iptal edildi.");
                    packedTitle.setText("İptal edildi");
        ...
        if(model.isCancellationrequested()){
            ...
            cancelOrderBtn.setText("İşlemde iptal");
        ...
        totalItems.setText("Fiyat("+model.getProductQuantity()+"ürün)");
        if(model.getDiscountedPrice().equals("")){
        ...
        if(model.getDeliveryPrice().equals("ÜCRETSİZ")){
            deliveryPrice.setText("ÜCRETSİZ");
        ...
        if(!model.getCuttedPrice().equals("")){
            if(!model.getDiscountedPrice().equals("")){
                savedAmount.setText("Bu siparişte" +(model.getProductQuantity())*(Long.valueOf(model.getCuttedPrice()) - Long.valueOf(model.getDiscountedPrice())) +"₺ tasarruf ettiniz");
            }else {
                savedAmount.setText("Bu siparişte"+(model.getProductQuantity())*(Long.valueOf(model.getCuttedPrice()) - Long.valueOf(model.getProductPrice())) +"₺ tasarruf ettiniz");
            }
        }else {
            if(!model.getDiscountedPrice().equals("")){
                savedAmount.setText("Bu siparişte" + (model.getProductQuantity())*(Long.valueOf(model.getProductPrice()) - Long.valueOf(model.getDiscountedPrice())) +"₺ tasarruf ettiniz");
            }else {
                savedAmount.setText("Bu siparişte ₺ tasarruf ettiniz");
            }
        }
