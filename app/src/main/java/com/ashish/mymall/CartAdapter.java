...
public class CartAdapter extends RecyclerView.Adapter {
        ...
        private void setItemDetails(final String productID, String resource, String title, Long freecoupansNo, final String productPriceText, String cuttedPriceText, Long offersAppliedNo, final int position, boolean inStock, final Long productQty, final Long maxQty, boolean qtyError, final List<String> qtyIDs, final long stockQty,boolean codAvaiiable){
            ...
            if(inStock) {
                if(freecoupansNo>0){
                    ...
                    if(freecoupansNo==1){
                        freeCoupans.setText("ücretsiz " + freecoupansNo + " kupon");
                    }else{
                        freeCoupans.setText("ücretsiz " + freecoupansNo + " kupon");
                    }
                }else {
                ...
                applyCoupanBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if(!TextUtils.isEmpty(cartItemModelList.get(position).getSelectedCoupanId())) {
                            ...
                            coupansApplied.setText( offerDiscountedAmount + "Kupon uygulandığında - ₺");
                ...
                removeCoupanBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        coupanTitle.setText("Kupon");
                        coupanExpiryDate.setText(" xx-xx-xxxx kadar");
                        coupanBody.setText("Kupon'unuzu seçmek için sağ üst köşedeki simgeye dokunun.");
                        ...
                        coupanRedemptionBody.setText("Kuponunuzu buraya uygulayın.");
                        reedemBtn.setText("Kupon uygulandığında");
                        productPrice.setText(productPriceText+" ₺");
                ...
                if(!TextUtils.isEmpty(cartItemModelList.get(position).getSelectedCoupanId())) {
                    for (RewardModel rewardModel : DBquerries.rewardModelList) {
                        if (rewardModel.getCoupanId().equals(cartItemModelList.get(position).getSelectedCoupanId())) {
                            ...
                            if(rewardModel.getType().equals("Discount")){
                                ...
                                coupanTitle.setText(rewardModel.getDiscORamt()+"₺"+" geçerli değil");
                            }
                            final SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd MMMM YYYY");
                            coupanExpiryDate.setText( simpleDateFormat.format(rewardModel.getTimestamp())+ "kadar ");
                        }
                    }
                    ...
                    coupanRedemptionLayout.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.coupanRed));
                    coupanRedemptionBody.setText("Kuponunuzu buraya uygulayın.");
                    reedemBtn.setText("Kuponu Uygula");

                }

                productQuantity.setText("Adet: "+String.valueOf(productQty));
                            ...
                            public void onClick(View view) {
                                if(!TextUtils.isEmpty(qtyNo.getText())) {
                                    if (Long.valueOf(qtyNo.getText().toString()) <= maxQty && Long.valueOf(qtyNo.getText().toString()) != 0) {
                                        ...
                                        productQuantity.setText("Adet: " + qtyNo.getText().toString());
                                        notifyItemChanged(cartItemModelList.size()-1);
                                                                                        ...
                                                                                        if (task.isSuccessful()) {
                                                                                            ...
                                                                                            for (String qtyID : qtyIDs) {
                                                                                                if (!serverQuantity.contains(qtyID)) {
                                                                                                    ...
                                                                                                    Toast.makeText(itemView.getContext(), "Üzgünüz, Gerekli miktar mevcut değil", Toast.LENGTH_SHORT).show();
                                                                                                }else {
                                                                                                    availableQty++;
                                                                                                }
                                                                                            }
                                        ...
                                        Toast.makeText(itemView.getContext(),"Ürün miktarı şundan küçük veya ona eşit olmalıdır "+maxQty,Toast.LENGTH_SHORT).show();
                                    }
                                }
                                qtyDialog.dismiss();
                            }
                ...
                if(offersAppliedNo>0){
                    ...
                    offersApplied.setText(offerDiscountedAmount+" ₺ indirim uygulandı ");
                }else {
                    offersApplied.setVisibility(View.INVISIBLE);
                }
            }
            else {
                productPrice.setText("Stoklar tükendi");
    ...
    class cartTotalAmountViewHolder extends RecyclerView.ViewHolder{
        ...
        private void setTotalAmount( int totalItemText, int totalItemPriceText,String deliveryPricetext,int totalAmounttext,int savedAmounttext){
            totalItems.setText("Fiyat("+totalItemText+" ürün)");
            ...
            savedAmount.setText("Bu siparişinizde "+savedAmounttext+"₺ tasarruf ettiniz.");
