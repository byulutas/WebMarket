...
import com.ashish.mymall.ui.Sepetim.MyCartFragment;
import com.ashish.mymall.ui.Web_Market.MyMallFragment;
import com.ashish.mymall.ui.Siparişlerim.MyOrdersFragment;
import com.ashish.mymall.ui.Kuponlarım.MyRewardsFragment;
import com.ashish.mymall.ui.İstek_Listem.MyWishlistFragment;
...
public class DBquerries {
    ...
    public static List<String> categoryNameList=new ArrayList<String>();
    ...
    public static int nameno=0;

    public static void loadCategories(final RecyclerView categoryRecyclerView, final Context context){
        categoryNameList.add(0,"Ana Sayfa");
        categoryNameList.add(1,"Mobil Telefonlar");
        categoryNameList.add(2,"Elektronik Aletler");
        categoryNameList.add(3,"Mutfak Aletleri");
        categoryNameList.add(4,"Mobilya");
        categoryNameList.add(5,"Moda");
        categoryNameList.add(6,"Kitaplar");
        categoryNameList.add(7,"Spor");
        categoryNameList.add(8,"Oyuncaklar");
        categoryNameList.add(9,"Sanatlar Ürünleri");
        categoryNameList.add(10,"Ayakkabılar");
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if(task.isSuccessful()){
                            for(QueryDocumentSnapshot queryDocumentSnapshot : task.getResult()){
                                categoryModelList.add(new CategoryModel(queryDocumentSnapshot.get("icon").toString(),categoryNameList.get(nameno).toString() ));
                                nameno=nameno+1;
                            }
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            ProductDetailsActivity.ALREADY_ADDED_TO_WISHLIST=false;
                            Toast.makeText(context,"Başarıyla Kaldırıldı!",Toast.LENGTH_SHORT).show();
                        } else {
                            if(ProductDetailsActivity.addToWishlistBtn != null) {
                                ProductDetailsActivity.addToWishlistBtn.setSupportImageTintList(context.getResources().getColorStateList(R.color.colorPrimary));
                            }
