...
import com.ashish.mymall.ui.Hesabım.MyAccountFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(showCart){
            ...
            gotoFragment("Sepetim",new MyCartFragment(),-2);
        }
        else {
                    ...
                    drawer.addDrawerListener(new DrawerLayout.SimpleDrawerListener() {
                        ...
                        public void onDrawerClosed(View drawerView) {
                            ...
                            if (id == R.id.nav_my_mall) {
                                ...
                                gotoFragment("Siparişlerim", new MyOrdersFragment(), ORDERS_FRAGMENT);
                            } else if (id == R.id.nav_my_rewards) {
                                gotoFragment("Kuponlarım", new MyRewardsFragment(), REWARDS_FRAGMENT);
                            } else if (id == R.id.nav_my_cart) {
                                gotoFragment("Sepetim", new MyCartFragment(), CART_FRAGMENT);
                            } else if (id == R.id.nav_my_wishlist) {
                                gotoFragment("İstek Listem", new MyWishlistFragment(), WISHLIST_FRAGMENT);
                            } else if (id == R.id.nav_my_account) {
                                gotoFragment("Hesabım", new MyAccountFragment(), MYACCOUNT_FRAGMENT);
                            } else if (id == R.id.nav_sign_out) {
                                FirebaseAuth.getInstance().signOut();
                                DBquerries.clearData();
                                DBquerries.email=null;
                                startActivity(new Intent(MainActivity.this,RegisterActivity.class));
                                finish();
                            }
