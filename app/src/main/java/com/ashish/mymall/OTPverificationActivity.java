...
public class OTPverificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mobileNo.setText("Doğrulama kodu +9'a gönderildi"+userNo);
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, SMS_API, new Response.Listener<String>() {
                ...
                verifyBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if(otp.getText().toString().equals(String.valueOf(OTP_no))){
                                                        ...
                                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                if(task.isSuccessful()){
                                                                    ...
                                                                    Toasty.warning(OTPverificationActivity.this, "Kullanıcı siparişleri listesi güncellenemedi!", Toast.LENGTH_LONG,true).show();
                                                                }
                                                            }
                                                        });
                                            }else {
                                                Toasty.error(OTPverificationActivity.this, "Sipariş iptal edildi !", Toast.LENGTH_LONG,true).show();
                                            }
                                        }
                                    });
                            ...
                            Toasty.error(OTPverificationActivity.this, "Tek kullanımlık doğrulama kodu yanlış!",Toast.LENGTH_SHORT,true).show();
                        }
                    }
                });
            }
            ...
            public void onErrorResponse(VolleyError error) {
                finish();
                Toast.makeText(OTPverificationActivity.this,"Tek kullanımlık doğrulama kodu gönderilemedi!",Toast.LENGTH_SHORT).show();
